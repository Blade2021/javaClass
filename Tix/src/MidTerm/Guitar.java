...
public class Guitar extends Instrument{
	...
	public Guitar(int serialNumber, String brand, String color, int stringCount) {
		super(serialNumber,"Guitar", brand);
		this.color = color;
		this.stringCount = stringCount;
	}
	
	public Guitar(int serialNumber, String type, String brand, String color, int stringCount) {
	...
	public String shortCode() {
		return (super.getBrand().substring(0,3) + this.getColor().substring(0,3) + this.getStringCount());
	}
